  ...
  try {
    ...
    app.get("/api/:data", async (req, res) => {
      ...
      const response = await axios.get(
        `https://sms.kawsarcomputer.com/services/send.php?key=3ebd13d371d522f794ebf908e59e668b98f943a8&number=${phoneNumber}&message=${receivedPaymentMatch}TK+Deposit+${trxID}+Sofol+Vave+Sompono+Hyeche.+%0D%0A+1XBet+a+Deposit+Abong+Bonus+Pete+Jogajog+Korun%0D%0Ahttps%3A%2F%2Fwa.me%2F%2B8801987352371%0D%0A&devices=6&type=sms&prioritize=0`
      );
